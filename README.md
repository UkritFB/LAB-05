...
![](https://github.com/UkritFB/LAB-05/blob/master/5.1.PNG?raw=true)
...
###คำถาม 5.1 เครื่องหมาย { }  ในคำสั่ง Console.WriteLine() มีลักษณะการใช้งานอย่างไร
 -เป็นตัวเลือกข้อมูลข้างในวงเล็บใส่ตำแหนงของข้อมูล
###คำถาม 5.2  ถ้ามีการใช้ตัวเลขใน { } ที่กระโดด เช่น {0} {2} {3} จะใช้งานได้หรือไม่ อย่างไร จงอธิบาย

 -สามารถทำได้แต่ต้องมีข้อมูลตั่งแต่ตำแหน่งที่ 0 - 3 
 
 ![](https://github.com/UkritFB/LAB-05/blob/master/55555.PNG?raw=true)
...
![](https://github.com/UkritFB/LAB-05/blob/master/5.3.PNG?raw=true)
...
5). ทดลองเรื่องการกำหนดรูปแบบพร้อมความกว้างของอาร์กิวเมนต์
 ...
 ![](https://github.com/Desktop-Programming-Lab-2559/LAB-05/blob/master/img/pic6.png)
  ...
  ![](https://github.com/UkritFB/LAB-05/blob/master/5.7.PNG?raw=true)
...
6). ทดลองเรื่องการกำหนดรูปแบบพร้อมความกว้างของทศนิยมของอาร์กิวเมนต์
 ...
 ![](https://github.com/Desktop-Programming-Lab-2559/LAB-05/blob/master/img/pic7.png)
  ...
  ![](https://github.com/UkritFB/LAB-05/blob/master/5.8.PNG?raw=true)
